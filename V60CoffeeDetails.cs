...
namespace SweetSpotDessertShop412
    {
        public partial class V60CoffeeDetails : Form
        {
            private TableLayoutPanel mainLayout;
            private string returnCategory = "Drinks";
            private bool allergenAcknowledged = false; 

            public V60CoffeeDetails()
            {
                InitializeComponent();
                SetupResponsiveScreen();
                this.Resize += V60CoffeeDetails_Resize;
                LoadItemDetails();
            }

            public V60CoffeeDetails(string category) : this()
            {
            ...
            {
                picProduct.Image = Properties.Resources.V60;
                lblItemName.Text = "V60 Pour-Over Coffee";
                lblPrice.Text = "BHD 2.500";
                lblDescription.Text = "Artisan pour-over coffee made with precision brewing. Clean, aromatic, and highlights the coffee's natural flavors.";
            ...
            private void V60CoffeeDetails_Resize(object sender, EventArgs e)
            {
            ...
            private void V60CoffeeDetails_Load(object sender, EventArgs e) { }
        }
    }