...
{
    public partial class ChocolateCakeDetails : Form
    {
        private TableLayoutPanel mainLayout;
        private string returnCategory = "Drinks";
        private bool allergenAcknowledged = false; 

        public ChocolateCakeDetails()
        {
            InitializeComponent();
            SetupResponsiveScreen();
            this.Resize += ChocolateCakeDetails_Resize;
            LoadItemDetails();
        }

        public ChocolateCakeDetails(string category) : this()
        {
        ...
        {
            picProduct.Image = Properties.Resources.chocolatecake;
            lblItemName.Text = "Chocolate Cake";
            lblPrice.Text = "BHD 3.500";
            lblDescription.Text = "Decadent layers of moist chocolate sponge with rich chocolate buttercream. A chocolate lover's dream made with premium cocoa.";
        ...
        private void ChocolateCakeDetails_Resize(object sender, EventArgs e)
        {
        ...
        private void ChocolateCakeDetails_Load(object sender, EventArgs e) { }
    }
}