...
{
    public partial class NutellaHotChocolateDetails : Form
    {
        ...
        // Item details
        private string itemName = "Nutella Hot Chocolate";
        private decimal itemPrice = 3.100m;

        public NutellaHotChocolateDetails()
        {
            InitializeComponent();
            SetupResponsiveScreen();
            this.Resize += NutellaHotChocolateDetails_Resize;
            LoadItemDetails();
        }

        public NutellaHotChocolateDetails(string category) : this()
        {
        ...
        {
            picProduct.Image = Properties.Resources.nutellahotchocolate;
            lblItemName.Text = itemName;
            lblPrice.Text = $"BHD {itemPrice:F3}";
            lblDescription.Text = "Rich hot chocolate blended with Nutella hazelnut spread, topped with whipped cream. A decadent and warming treat.";
            lblAllergenContent.Text = "Contains: MILK, TREE NUTS (HAZELNUTS), SOY.\r\nMay contain peanuts and gluten.";
        }
        ...
        private void BtnAddToBasket_Click(object sender, EventArgs e)
        {
            ...
            BasketManager.AddItem(itemName, itemPrice, quantity, returnCategory);
        ...
        private void ShowPostAddDialog()
        {
            ...
            {
                Text = $"✓ {numQuantity.Value} x {itemName} added to basket!\n\nWhat would you like to do next?",
        ...
        private void NutellaHotChocolateDetails_Resize(object sender, EventArgs e)
        {
        ...
        private void NutellaHotChocolateDetails_Load(object sender, EventArgs e) { }
    }
}