...
namespace SweetSpotDessertShop412
    {
        public partial class SweetSpotSignatureDetails : Form
        {
            private TableLayoutPanel mainLayout;
            private string returnCategory = "Drinks";
            private bool allergenAcknowledged = false; 

            public SweetSpotSignatureDetails()
            {
                InitializeComponent();
                SetupResponsiveScreen();
                this.Resize += SweetSpotSignatureDetails_Resize;
                LoadItemDetails();
            }

            public SweetSpotSignatureDetails(string category) : this()
            {
            ...
            {
                picProduct.Image = Properties.Resources.Sweet_Spot_Signature;
                lblItemName.Text = "Sweet Spot Signature";
                lblPrice.Text = "BHD 3.300";
                lblDescription.Text = "Our exclusive house creation: layers of chocolate mousse, caramel, and vanilla cream with crunchy praline. A truly unforgettable dessert.";
                lblAllergenContent.Text = "Contains: MILK, EGGS, GLUTEN (WHEAT), SOY, TREE NUTS (ALMONDS).\r\nMay contain peanuts.";
            }
        ...
        private void SweetSpotSignatureDetails_Resize(object sender, EventArgs e)
        {
        ...
        private void SweetSpotSignatureDetails_Load(object sender, EventArgs e) { }
    }
}