...
namespace SweetSpotDessertShop412
    {
        public partial class LamingtonCoconutChocolateCakeDetails : Form
        {
            private TableLayoutPanel mainLayout;
            private string returnCategory = "Drinks";
            private bool allergenAcknowledged = false; 

            public LamingtonCoconutChocolateCakeDetails()
            {
                InitializeComponent();
                SetupResponsiveScreen();
                this.Resize += LamingtonCoconutChocolateCakeDetails_Resize;
                LoadItemDetails();
            }

            public LamingtonCoconutChocolateCakeDetails(string category) : this()
            {
            ...
            {
                picProduct.Image = Properties.Resources.Lamington_Coconut_Chocolate_Cake;
                lblItemName.Text = "Lamington Coconut-Chocolate Cake";
                lblPrice.Text = "BHD 3.800";
                lblDescription.Text = "Australian classic: soft sponge cake dipped in chocolate and rolled in desiccated coconut. A delightful texture combination.";
                lblAllergenContent.Text = "Contains: MILK, EGGS, GLUTEN (WHEAT), SOY.\r\nMay contain tree nuts and peanuts.";
            }
            ...
            private void LamingtonCoconutChocolateCakeDetails_Resize(object sender, EventArgs e)
            {
            ...
            private void LamingtonCoconutChocolateCakeDetails_Load(object sender, EventArgs e) { }
        }
    }