...
namespace SweetSpotDessertShop412
    {
        public partial class CheesecakeDetails : Form
        {
            private TableLayoutPanel mainLayout;
            private string returnCategory = "Drinks";
            private bool allergenAcknowledged = false; 

            public CheesecakeDetails()
            {
                InitializeComponent();
                SetupResponsiveScreen();
                this.Resize += CheesecakeDetails_Resize;
                LoadItemDetails();
            }

            public CheesecakeDetails(string category) : this()
            {
            ...
            {
                picProduct.Image = Properties.Resources.Cheesecake;
                lblItemName.Text = "Cheesecake";
                lblPrice.Text = "BHD 5.000";
                lblDescription.Text = "Creamy New York-style cheesecake with a buttery graham cracker crust. Smooth, rich, and perfectly balanced sweetness.";
            ...
            private void CheesecakeDetails_Resize(object sender, EventArgs e)
            {
            ...
            private void CheesecakeDetails_Load(object sender, EventArgs e) { }
        }
    }
