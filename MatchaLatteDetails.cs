...
namespace SweetSpotDessertShop412
    {
        public partial class MatchaLatteDetails : Form
        {
            private TableLayoutPanel mainLayout;
            private string returnCategory = "Drinks";
            private bool allergenAcknowledged = false; 

            public MatchaLatteDetails()
            {
                InitializeComponent();
                SetupResponsiveScreen();
                this.Resize += MatchaLatteDetails_Resize;
                LoadItemDetails();
            }

            public MatchaLatteDetails(string category) : this()
            {
            ...
            {
                picProduct.Image = Properties.Resources.Matcha_Latte;
                lblItemName.Text = "Matcha Latte";
                lblPrice.Text = "BHD 3.300";
                lblDescription.Text = "Premium Japanese matcha green tea whisked with steamed milk. Earthy, vibrant, and packed with antioxidants.";
            ...
            private void MatchaLatteDetails_Resize(object sender, EventArgs e)
            {
            ...
            private void MatchaLatteDetails_Load(object sender, EventArgs e) { }
        }
    }