...
namespace SweetSpotDessertShop412
    {
        public partial class PeachIcedTeaDetails : Form
        {
            private TableLayoutPanel mainLayout;
            private string returnCategory = "Drinks";
            private bool allergenAcknowledged = false; 

            public PeachIcedTeaDetails()
            {
                InitializeComponent();
                SetupResponsiveScreen();
                this.Resize += PeachIcedTeaDetails_Resize;
                LoadItemDetails();
            }

            public PeachIcedTeaDetails(string category) : this()
            {
            ...
            {
                picProduct.Image = Properties.Resources.Peach_Iced_Tea;
                lblItemName.Text = "Peach Iced Tea";
                lblPrice.Text = "BHD 2.200";
                lblDescription.Text = "Refreshing black tea infused with sweet peach flavor, served ice-cold. A perfect thirst quencher on warm days.";
                lblAllergenContent.Text = "No common allergens.\r\nMay contain traces of sulfites.";
            }
            ...
            private void PeachIcedTeaDetails_Resize(object sender, EventArgs e)
            {
            ...
            private void PeachIcedTeaDetails_Load(object sender, EventArgs e) { }
        }
    }