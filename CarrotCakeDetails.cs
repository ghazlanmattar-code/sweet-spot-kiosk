...
namespace SweetSpotDessertShop412
    {
        public partial class CarrotCakeDetails : Form
        {
            private TableLayoutPanel mainLayout;
            private string returnCategory = "Drinks";
            private bool allergenAcknowledged = false; 

            public CarrotCakeDetails()
            {
                InitializeComponent();
                SetupResponsiveScreen();
                this.Resize += CarrotCakeDetails_Resize;
                LoadItemDetails();
            }

            public CarrotCakeDetails(string category) : this()
            {
            ...
            {
                picProduct.Image = Properties.Resources.Carrotcake;
                lblItemName.Text = "Carrot Cake";
                lblPrice.Text = "BHD 3.900";
                lblDescription.Text = "Moist spiced cake with fresh carrots, walnuts, and cream cheese frosting. A wholesome and flavorful classic dessert.";
                lblAllergenContent.Text = "Contains: MILK, EGGS, GLUTEN (WHEAT), TREE NUTS (WALNUTS).\r\nMay contain soy and peanuts.";
            }
            ...
            private void CarrotCakeDetails_Resize(object sender, EventArgs e)
            {
            ...
            private void CarrotCakeDetails_Load(object sender, EventArgs e) { }
        }
    }
