...
{
    public partial class IcedCaramelLatteDetails : Form
    {
        private TableLayoutPanel mainLayout;
        private string returnCategory = "Drinks";
        private bool allergenAcknowledged = false; 

        public IcedCaramelLatteDetails()
        {
            InitializeComponent();
            SetupResponsiveScreen();
            this.Resize += IcedCaramelLatteDetails_Resize;
            LoadItemDetails();
        }

        public IcedCaramelLatteDetails(string category) : this()
        {
        ...
        {
            picProduct.Image = Properties.Resources.Iced_Caramel_Latte;
            lblItemName.Text = "Iced Caramel Latte";
            lblPrice.Text = "BHD 2.900";
            lblDescription.Text = "Smooth espresso blended with cold milk and sweet caramel syrup, served over ice. A refreshing and indulgent coffee treat.";
        ...
        private void IcedCaramelLatteDetails_Resize(object sender, EventArgs e)
        {
        ...
        private void IcedCaramelLatteDetails_Load(object sender, EventArgs e) { }
    }
}