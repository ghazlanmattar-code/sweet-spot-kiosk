...
namespace SweetSpotDessertShop412
    {
        public partial class RedVelvetCakeDetails : Form
        {
            private TableLayoutPanel mainLayout;
            private string returnCategory = "Drinks";
            private bool allergenAcknowledged = false; 

            public RedVelvetCakeDetails()
            {
                InitializeComponent();
                SetupResponsiveScreen();
                this.Resize += RedVelvetCakeDetails_Resize;
                LoadItemDetails();
            }

            public RedVelvetCakeDetails(string category) : this()
            {
            ...
            {
                picProduct.Image = Properties.Resources.redvelvetcake;
                lblItemName.Text = "Red Velvet Cake";
                lblPrice.Text = "BHD 4.200";
                lblDescription.Text = "Luxurious red velvet layers with tangy cream cheese frosting. A Southern classic with its signature vibrant color and subtle cocoa flavor.";
                lblAllergenContent.Text = "Contains: MILK, EGGS, GLUTEN (WHEAT), FOOD COLORING.\r\nMay contain traces of soy and tree nuts.";
            }
        ...
        private void RedVelvetCakeDetails_Resize(object sender, EventArgs e)
        {
        ...
        private void RedVelvetCakeDetails_Load(object sender, EventArgs e) { }
    }
}