...
namespace SweetSpotDessertShop412
    {
        public partial class VanillaColdBrewDetails : Form
        {
            private TableLayoutPanel mainLayout;
            private string returnCategory = "Drinks";
            private bool allergenAcknowledged = false; 

            public VanillaColdBrewDetails()
            {
                InitializeComponent();
                SetupResponsiveScreen();
                this.Resize += VanillaColdBrewDetails_Resize;
                LoadItemDetails();
            }

            public VanillaColdBrewDetails(string category) : this()
            {
            ...
            {
                picProduct.Image = Properties.Resources.Vanilla_Cold_Brew;
                lblItemName.Text = "Vanilla Cold Brew";
                lblPrice.Text = "BHD 2.600";
                lblDescription.Text = "Smooth cold-brewed coffee infused with vanilla, served chilled. A mellow and naturally sweet coffee experience.";
                lblAllergenContent.Text = "May contain soy.";
            }
            ...
            private void VanillaColdBrewDetails_Resize(object sender, EventArgs e)
            {
            ...
            private void VanillaColdBrewDetails_Load(object sender, EventArgs e) { }
        }
    }