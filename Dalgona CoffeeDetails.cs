...
namespace SweetSpotDessertShop412
    {
        public partial class DalgonaCoffeeDetails : Form
        {
            private TableLayoutPanel mainLayout;
            private string returnCategory = "Drinks";
            private bool allergenAcknowledged = false;

            public DalgonaCoffeeDetails()
            {
                InitializeComponent();
                SetupResponsiveScreen();
                this.Resize += DalgonaCoffeeDetails_Resize;
                LoadItemDetails();
            }

            public DalgonaCoffeeDetails(string category) : this()
            {
            ...
            {
                picProduct.Image = Properties.Resources.Dalgona_Coffee__Whipped_Coffee_Drink_;
                lblItemName.Text = "Dalgona Coffee";
                lblPrice.Text = "BHD 2.700";
                lblDescription.Text = "Trendy Korean whipped coffee: fluffy coffee foam over cold milk. Instagram-worthy and deliciously satisfying.";
            ...
            private void DalgonaCoffeeDetails_Resize(object sender, EventArgs e)
            {
            ...
            private void DalgonaCoffeeDetails_Load(object sender, EventArgs e) { }
        }
    }