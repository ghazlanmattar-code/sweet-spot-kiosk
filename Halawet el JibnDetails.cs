...
namespace SweetSpotDessertShop412
    {
        public partial class HalawetElJibnDetails : Form
        {
            private TableLayoutPanel mainLayout;
            private string returnCategory = "Drinks";
            private bool allergenAcknowledged = false; 

            public HalawetElJibnDetails()
            {
                InitializeComponent();
                SetupResponsiveScreen();
                this.Resize += HalawetElJibnDetails_Resize;
                LoadItemDetails();
            }

            public HalawetElJibnDetails(string category) : this()
            {
            ...
            {
                picProduct.Image = Properties.Resources.Halawet_el_Jibn__Middle_Eastern_Cheese___Semolina_Dessert_;
                lblItemName.Text = "Halawet el Jibn";
                lblPrice.Text = "BHD 3.600";
                lblDescription.Text = "Traditional Middle Eastern delicacy: sweet cheese dough rolled with clotted cream, drizzled with rose syrup. An authentic taste experience.";
                lblAllergenContent.Text = "Contains: MILK.\r\nMay contain gluten and tree nuts (pistachios).";
            }
            ...
            private void HalawetElJibnDetails_Resize(object sender, EventArgs e)
            {
            ...
            private void HalawetElJibnDetails_Load(object sender, EventArgs e) { }
        }
    }