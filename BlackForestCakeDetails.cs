...
namespace SweetSpotDessertShop412
    {
        public partial class BlackForestCakeDetails : Form
        {
            private TableLayoutPanel mainLayout;
            private string returnCategory = "Drinks";
            private bool allergenAcknowledged = false; 

            public BlackForestCakeDetails()
            {
                InitializeComponent();
                SetupResponsiveScreen();
                this.Resize += BlackForestCakeDetails_Resize;
                LoadItemDetails();
            }

            public BlackForestCakeDetails(string category) : this()
            {
            ...
            {
                picProduct.Image = Properties.Resources.BlackForestCake;
                lblItemName.Text = "Black Forest Cake";
                lblPrice.Text = "BHD 4.800";
                lblDescription.Text = "Traditional German chocolate cake with cherry filling, whipped cream, and chocolate shavings. A timeless European favorite.";
                lblAllergenContent.Text = "Contains: MILK, EGGS, GLUTEN (WHEAT), ALCOHOL (KIRSCH).\r\nMay contain tree nuts and peanuts.";
            }
            ...
            private void BlackForestCakeDetails_Resize(object sender, EventArgs e)
            {
            ...
            private void BlackForestCakeDetails_Load(object sender, EventArgs e) { }
        }
    }
